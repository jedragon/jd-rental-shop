...
namespace VideoRental
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Movie regular1 = new Movie("일반 1", Movie.romanticComedy, Movie.REGULAR);
            Movie regular2 = new Movie( "일반 2", Movie.spaceOpera, Movie.REGULAR);
            Movie newRelease1 = new Movie( "신작 1", Movie.thiller, Movie.NEW_RELEASE );
            Movie newRelease2 = new Movie( "신작 2", Movie.thiller, Movie.NEW_RELEASE );
            Movie children1 = new Movie( "어린이 1", Movie.spaceOpera, Movie.CHILDRENS );
            Movie children2 = new Movie( "어린이 2", Movie.spaceOpera, Movie.CHILDRENS );
